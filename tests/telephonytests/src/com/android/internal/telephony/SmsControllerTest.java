...
public class SmsControllerTest extends TelephonyTest {
    ...
    public void sendStoredText_associatedUser_sendsSms() {
        ...
        verify(mIccSmsInterfaceManager).sendStoredText(eq(mCallingPackage),
            isNull(), any(), isNull(), isNull(), isNull());
    }
    ...
    public void sendStoredText_notAssociatedUser_fails() {
        ...
        verify(mIccSmsInterfaceManager, never()).sendStoredText(any(), any(), any(),
            any(), any(), any());
    }
    ...
    public void sendStoredMultipartText_notAssociatedUser_fails() {
        ...
        verify(mIccSmsInterfaceManager, never()).sendStoredMultipartText(any(), any(), any(),
            any(), any(), any());
    }
}
